...
("arial", "10"), command = choose_color)
button_cercle = tk.Button(root, text="Cercle", font = ("arial", "10"), command= cicrle)
button_carré = tk.Button(root, text="Carré", font = ("arial", "10"), command = carre)
button_croix = tk.Button(root, text="Croix", font = ("arial", "10"), command = draw_cross)
button_undo = tk.Button(root, text = 'Undo', font = ("arial", "10"), command = undo )
